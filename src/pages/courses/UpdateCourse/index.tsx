...
import LessonSection from '../CreateCourse/LessonSection'
...
const UpdateCourse = () => {
  ...
  const prepareCategory = (categories: any) => {
    const _categoriesId = listCategory
      ?.filter((cate: any) => categories?.includes(cate?._id))
  ...
  const initialValues: IValues = {
    ...
    categories: course?.categories ? prepareCategory(course?.categories) : [],
